...
public class MyHuiFuFrm extends JFrame {
	...
	public MyHuiFuFrm() {
		...
		ziTi.ziTi();
		setBg();
		setIconImage(Toolkit.getDefaultToolkit().getImage(MyHuiFuFrm.class.getResource("/tupian/\u56FE\u68073.jpg")));
		setTitle("\u6211\u7684\u56DE\u590D");
		...
		MyTieZiLabel.setIcon(new ImageIcon(MyHuiFuFrm.class.getResource("/tupian/me.png")));
		...
		jiaZaiButton.setIcon(new ImageIcon(MyHuiFuFrm.class.getResource("/tupian/search.png")));
		
		JButton button = new JButton("\u5220\u9664");
		
		button.setIcon(new ImageIcon(MyHuiFuFrm.class.getResource("/tupian/exit.png")));
