 ...
 *
 */
public class M_NRServiece implements IMyService{
	private static Logger logger = Logger.getLogger(M_NRServiece.class);
...
//		logger.debug(str);
		...
		String sqlTieZi = SqlPingJie.sqlTieZi2(text[0],text[1]);
