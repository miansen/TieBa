 ...
 *
 */
public class MyTieZiModel implements TableModel {
	private static Logger logger = Logger.getLogger(MyTieZiModel.class);
	...
	public MyTieZiModel(List<Map<String, Object>> data2) {
		this.data = data2;
	}
